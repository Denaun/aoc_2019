...
RSpec.describe Day3 do
  ...
  it 'solves the examples' do
    expect(Day3.solve('R75,D30,R83,U83,L12,D49,R71,U7,L72',
                      'U62,R66,U55,R34,D71,R55,D58,R83')).to eq(159)
    expect(Day3.solve('R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51',
                      'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7')).to eq(135)
  end

  it 'solves part 1' do
    puzzle_input = File.open(File.join(File.dirname(__FILE__), 'input')).collect.to_a
    expect(Day3.solve(puzzle_input[0], puzzle_input[1])).to eq(721)
  end
end
